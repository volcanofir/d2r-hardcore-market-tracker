...
const RUNE_ROWS=['assets/runes-row1-hd.webp?v=20260824-userhd2','assets/runes-row2-hd.webp?v=20260824-userhd2','assets/runes-row3-hd.webp?v=20260824-userhd2'];
function runeStyle(i){const row=Math.floor(i/11),col=i%11;return `background-image:url('${RUNE_ROWS[row]}');background-position:calc(var(--rune-w) * -${col}) 0`}
async function load(){
  try{
